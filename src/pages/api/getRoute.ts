...
type ValidResponse = { swapRoute: SwapRoute, formattedInputAmount: string, formattedOutputAmount: string } | { error: string }
export default async function handler(
    req: NextApiRequest,
    res: NextApiResponse<ValidResponse>
) {
    if (req.method !== 'POST') {
