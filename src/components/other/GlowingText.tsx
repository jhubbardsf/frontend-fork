...
const GlowingText = styled.p`
    ...
    background: linear-gradient(to right, rgba(255, 255, 255, 0.8) 0%, rgba(255, 255, 255, 1) 50%, rgba(255, 255, 255, 0.8) 100%);
...
const GlowingShimmerText = ({ text }) => <GlowingText>{text}</GlowingText>;

// Default props in case no text is provided
GlowingShimmerText.defaultProps = {
    text: 'The Rift early alpha is paused in preperation for our upcoming Base launch!',
};
