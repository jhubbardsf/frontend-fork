                        ...
                        <>
                            <Flex w='100%' flexDir='column' position='relative'>
                                ...
                                <Flex
                                    ...
                                    cursor={'pointer'}
                                    _hover={{ bg: '#333' }}
                                    onClick={() => toastInfo({ title: 'BTC -> ERC-20 swaps coming soon!', description: 'if only bitcoin had OP_CAT, this would be a lot easier to build!' })}
                                    position={'absolute'}
                                    bg='#161616'
                            ...
                            <Flex
                                ...
                                <Text color={canProceedWithDeposit() ? colors.offWhite : colors.darkerGray} fontFamily='Nostromo'>
                                    {canProceedWithDeposit() ? 'Exchange' : 'Swaps Disabled'}
                                </Text>
                            </Flex>
                        </>
                    )}
