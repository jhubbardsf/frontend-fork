...
export const Navbar = ({}) => {
    ...
    const mapStateNumberToString = (
        stateNumber: number,
    ): '0-not-started' | '1-finding-liquidity' | '2-awaiting-payment' | '3-payment-recieved' => {
        switch (stateNumber) {
            case 0:
            ...
            {displayWarning == true && (
                <>
                    <Flex
                        ...
                        {/* @ts-ignore */}
                        <GlowingShimmerText>
                            The Rift early alpha is awaiting audits - swaps are limited to 100 USDT - use at your own
                            risk
                        </GlowingShimmerText>
                        <Flex
                            // h='100%'
                            ...
                            <Box
                                ...
                                onClick={() => {
                                    ...
                                    if (currentStateNumber > 0) {
                                        useStore.setState({
                                            depositFlowState: mapStateNumberToString(currentStateNumber - 1),
                                        });
                                    }
                                }}
                            />
